...
import { AÑADIR_A_CANASTA, BORRAR_TODOS_CANASTA, BORRAR_UNO_CANASTA, CALCULAR_TOTAL, CARGAR_PRODUCTOS } from "../Types"
...
export const delToCart = (id, cantidad, opcion) => {
    if (opcion == 1) { ///Clic en Borrar todos
        ...
        return cantidad > 1 ? { type: BORRAR_UNO_CANASTA, payload: id }
